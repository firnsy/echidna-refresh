package Echidna::Database::MYSQL;
...
use Module::Pluggable
    search_path => 'Echidna::Database::MYSQL',
    sub_name => 'entities',
    except => qr/Object$/;
...
sub new {
    ...
    unless (ref $instance eq __PACKAGE__) {
        $instance = bless {
            ...
            __return_objects => 0,
            __loaded_models => [],
            __logger  => Echidna::Common::Registry->get('log'),
        }, $class;
...
sub call {
    ...
    my $entity = 'Echidna::Database::MYSQL::' .ucfirst $object;
